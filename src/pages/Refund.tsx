...
const Refund = () => (
  <LegalLayout eyebrow="Legal · Refund" title="Refund & Cancellation Policy" effectiveDate="May 2026">
    ...
    <p>
      This policy applies to <strong>booking deposits</strong> collected through our designated
      payment processor (currently Xendit) and to any service fees paid directly to MVM. Free
      consultations and uncharged inquiries are out of scope.
    </p>
    ...
    <h2>4. Service-Failure Refunds</h2>
    <p>
    ...
    <ul>
      ...
      <li>Xendit transaction ID or invoice number;</li>
